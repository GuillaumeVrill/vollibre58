...
//PATH:
define('URL_PATH', 'http://vollibre58.fr/');	// Path de l'application : à modifier
...
require_once($root."modele/Administrateur.php");
require_once($root."modele/UtilisateurClassique.php");
require_once($root."modele/Redacteur.php");
