        ...
        switch ($articles[$i]->getIdDisposition()){
            case 1:
                echo '<div class="blogArticle std">'
                    ...
                    . '<a href="'.$pic[0].'" target="_blank"><img src="'.$pic[0].'" /></a>'
                    . '</div>'
            ...
            case 2:
                echo '<div class="blogArticle pic3">'
                    ...
                    . '<a href="'.$pic[1].'" target="_blank"><img src="'.$pic[1].'" /></a>'
                    . '<a href="'.$pic[2].'" target="_blank"><img src="'.$pic[2].'" /></a>'
                    . '</div>'
                    . '</div>'
                    . '<div class="content">'.$articles[$i]->getTexte2().'</div>'
                    . '</div>';
            ...
            case 3:
                echo '<div class="blogArticle pic3-inv">'
                    ...
                    . '<div class="img-petite">'
                    . '<a href="'.$pic[0].'" target="_blank"><img src="'.$pic[1].'" /></a>'
                    . '<a href="'.$pic[1].'" target="_blank"><img src="'.$pic[2].'" /></a>'
                    . '</div>'
                    . '<div class="img-grande">'
                    . '<a href="'.$pic[2].'" target="_blank"><img src="'.$pic[0].'" /></a>'
                    . '</div>'
                    . '</div>'
                    . '<div class="content">'.$articles[$i]->getTexte2().'</div>'
                    . '</div>';
            ...
            case 4:
                echo '<div class="blogArticle pic2">'
                    ...
                    . '<div class="demi"><a href="'.$pic[0].'" target="_blank"><img src="'.$pic[0].'" /></a></div>'
                    . '<div class="demi"><a href="'.$pic[1].'" target="_blank"><img src="'.$pic[1].'" /></a></div>'
                    . '</div>'
                    . '<div class="content">'.$articles[$i]->getTexte2().'</div>'
                    . '</div>';
                break;
