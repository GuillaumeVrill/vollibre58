...
<div class="row">
    <div id="bilanPDF" class="col-xs-12">
        <h4>Les bilans de l'ann&eacute;e en cours:</h4>
        <a href="<?php print STATIC_PATH; ?>/PDF/BilanAG2015.pdf" target="_blank">
            <img class="pdf-logo" src="<?php print STATIC_PATH; ?>/images/icones/logoPDF.png" /> Bilan de l'AG
        </a>
        <a href="<?php print STATIC_PATH; ?>/PDF/BilanActiviteAG2015.pdf" target="_blank">
            <img class="pdf-logo" src="<?php print STATIC_PATH; ?>/images/icones/logoPDF.png" /> Bilan Activit&eacute;
        </a>
        <a href="<?php print STATIC_PATH; ?>/PDF/BilanFinancierAG2015.pdf" target="_blank">
