    ...
    <div class="col-xs-12 addEventPage">
        ...
        <form method="post" action="?page=f_add_event">
            ...
            <div class="event_line">
                ...
                <input type="text" name="titreEvent" id="titreEvent" placeholder="Ex: Sortie puy de dome" />
            </div>
            <div class="event_line">
                <label for="descrEvent">Description</label>
                <textarea name="descrEvent" id="descrEvent" rows="3" cols="50" resize="none" maxlength="255"></textarea>
            </div>
